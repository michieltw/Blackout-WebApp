...
CREATE UNIQUE INDEX idx_event_rsvp_event_id_user_id ON event_rsvp (event_id, user_id);
...
CREATE UNIQUE INDEX idx_player_stats_player_id_season_id_team_id ON player_stats (player_id, season_id, team_id);
CREATE UNIQUE INDEX idx_goalie_stats_player_id_season_id_team_id ON goalie_stats (player_id, season_id, team_id);
CREATE UNIQUE INDEX idx_team_stats_team_id_season_id ON team_stats (team_id, season_id);
...
ALTER TABLE user_accounts ADD CONSTRAINT fk_user_accounts_person_id_persons FOREIGN KEY (person_id) REFERENCES persons(id);
ALTER TABLE user_accounts ADD CONSTRAINT fk_user_accounts_role_id_roles FOREIGN KEY (role_id) REFERENCES roles(id);
ALTER TABLE user_accounts ADD CONSTRAINT fk_user_accounts_preferred_organization_id_organizations FOREIGN KEY (preferred_organization_id) REFERENCES organizations(id);
...
ALTER TABLE membership_fees ADD CONSTRAINT fk_membership_fees_paid_by_user_accounts FOREIGN KEY (paid_by) REFERENCES user_accounts(id);
...
ALTER TABLE member_status_log ADD CONSTRAINT fk_member_status_log_changed_by_user_accounts FOREIGN KEY (changed_by) REFERENCES user_accounts(id);
ALTER TABLE user_profiles ADD CONSTRAINT fk_user_profiles_user_id_user_accounts FOREIGN KEY (user_id) REFERENCES user_accounts(id);
...
ALTER TABLE game_approvals ADD CONSTRAINT fk_game_approvals_approved_by_user_accounts FOREIGN KEY (approved_by) REFERENCES user_accounts(id);
...
ALTER TABLE expenses ADD CONSTRAINT fk_expenses_recorded_by_user_accounts FOREIGN KEY (recorded_by) REFERENCES user_accounts(id);
...
ALTER TABLE event_rsvp ADD CONSTRAINT fk_event_rsvp_event_id_events FOREIGN KEY (event_id) REFERENCES events(id);
ALTER TABLE event_rsvp ADD CONSTRAINT fk_event_rsvp_user_id_user_accounts FOREIGN KEY (user_id) REFERENCES user_accounts(id);
ALTER TABLE messages ADD CONSTRAINT fk_messages_sender_id_user_accounts FOREIGN KEY (sender_id) REFERENCES user_accounts(id);
ALTER TABLE messages ADD CONSTRAINT fk_messages_recipient_id_user_accounts FOREIGN KEY (recipient_id) REFERENCES user_accounts(id);
...
ALTER TABLE documents ADD CONSTRAINT fk_documents_uploaded_by_user_accounts FOREIGN KEY (uploaded_by) REFERENCES user_accounts(id);
...
ALTER TABLE game_attendance ADD CONSTRAINT fk_game_attendance_recorded_by_user_accounts FOREIGN KEY (recorded_by) REFERENCES user_accounts(id);
...
ALTER TABLE game_scheduling_conflicts ADD CONSTRAINT fk_game_scheduling_conflicts_resolved_by_user_accounts FOREIGN KEY (resolved_by) REFERENCES user_accounts(id);
...
ALTER TABLE sponsorship_payments ADD CONSTRAINT fk_sponsorship_payments_recorded_by_user_accounts FOREIGN KEY (recorded_by) REFERENCES user_accounts(id);
...
ALTER TABLE announcements ADD CONSTRAINT fk_announcements_published_by_user_accounts FOREIGN KEY (published_by) REFERENCES user_accounts(id);
...
ALTER TABLE social_media_posts ADD CONSTRAINT fk_social_media_posts_created_by_user_accounts FOREIGN KEY (created_by) REFERENCES user_accounts(id);
...
ALTER TABLE season_archives ADD CONSTRAINT fk_season_archives_created_by_user_accounts FOREIGN KEY (created_by) REFERENCES user_accounts(id);
ALTER TABLE dashboard_widgets ADD CONSTRAINT fk_dashboard_widgets_user_id_user_accounts FOREIGN KEY (user_id) REFERENCES user_accounts(id);
...
ALTER TABLE event_status_log ADD CONSTRAINT fk_event_status_log_changed_by_user_accounts FOREIGN KEY (changed_by) REFERENCES user_accounts(id);
...
ALTER TABLE bulk_import_staging ADD CONSTRAINT fk_bulk_import_staging_imported_by_user_accounts FOREIGN KEY (imported_by) REFERENCES user_accounts(id);
...
ALTER TABLE player_stats ADD CONSTRAINT fk_player_stats_player_id_players FOREIGN KEY (player_id) REFERENCES players(id) ON DELETE CASCADE;
ALTER TABLE player_stats ADD CONSTRAINT fk_player_stats_season_id_seasons FOREIGN KEY (season_id) REFERENCES seasons(id) ON DELETE CASCADE;
ALTER TABLE player_stats ADD CONSTRAINT fk_player_stats_team_id_teams FOREIGN KEY (team_id) REFERENCES teams(id) ON DELETE CASCADE;
ALTER TABLE goalie_stats ADD CONSTRAINT fk_goalie_stats_player_id_players FOREIGN KEY (player_id) REFERENCES players(id) ON DELETE CASCADE;
ALTER TABLE goalie_stats ADD CONSTRAINT fk_goalie_stats_season_id_seasons FOREIGN KEY (season_id) REFERENCES seasons(id) ON DELETE CASCADE;
ALTER TABLE goalie_stats ADD CONSTRAINT fk_goalie_stats_team_id_teams FOREIGN KEY (team_id) REFERENCES teams(id) ON DELETE CASCADE;
ALTER TABLE team_stats ADD CONSTRAINT fk_team_stats_team_id_teams FOREIGN KEY (team_id) REFERENCES teams(id) ON DELETE CASCADE;
ALTER TABLE team_stats ADD CONSTRAINT fk_team_stats_season_id_seasons FOREIGN KEY (season_id) REFERENCES seasons(id) ON DELETE CASCADE;
...
ALTER TABLE event_rsvps ADD CONSTRAINT fk_event_rsvps_event_id_events FOREIGN KEY (event_id) REFERENCES events(id) ON DELETE CASCADE;
ALTER TABLE event_rsvps ADD CONSTRAINT fk_event_rsvps_user_id_users FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE;
